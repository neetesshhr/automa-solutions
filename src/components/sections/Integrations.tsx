...
const Integrations = () => {
  return (
    <section id="integrations" className="py-16 md:py-24 animate-enter">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {categories.map((cat) => (
            <article key={cat.name} className="rounded-lg border p-6 bg-card shadow-elevated hover-scale">
