...
const FAQ = () => {
  return (
    <section id="faq" className="py-16 md:py-24 animate-enter">
      <div className="container mx-auto">
        <h2 className="text-3xl font-semibold mb-6">Frequently asked questions</h2>
        <Accordion type="single" collapsible className="w-full max-w-3xl">
          <AccordionItem value="item-1">
          <AccordionTrigger>What is EffortZero?</AccordionTrigger>
          <AccordionContent>
            EffortZero is a managed automation partner. We design, build, and run workflows that connect your tools and data, focusing on reliability and measurable ROI.
            </AccordionContent>
          </AccordionItem>
